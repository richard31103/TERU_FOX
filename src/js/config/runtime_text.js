...
export const OPENING_TEXT = {
    tw: {
        ...
        unfinishedRoutesLine: '提爾還沒做完這條線',
    ...
    cn: {
        ...
        unfinishedRoutesLine: '提尔还没做完这条线',
    ...
    en: {
        ...
        unfinishedRoutesLine: 'TERU has not finished this route yet.',
    ...
    jp: {
        ...
        unfinishedRoutesLine: 'テールはまだこのルートを作り終えてないよ。',
